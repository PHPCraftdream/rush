// End-to-end VCR-backed coder-agent tests: the TestCoderAgent matrix
// exercising agent.Run against every tool, plus the modelPair/setup
// helpers (modelPairs, getModels, setupAgent) it runs on.
