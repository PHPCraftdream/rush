...
func TestNewRushLogsTool(t *testing.T) {
	t.Parallel()
	tool := NewRushLogsTool("/tmp/test.log")
	require.NotNil(t, tool)
	require.Equal(t, RushLogsToolName, tool.Info().Name)
}

func TestRushLogs_HappyPath(t *testing.T) {
	t.Parallel()
	...
	result := runRushLogs(logFile, RushLogsParams{Lines: 3})
...
func TestRushLogs_DefaultLines(t *testing.T) {
	t.Parallel()
	...
	result := runRushLogs(logFile, RushLogsParams{Lines: 0})
...
func TestRushLogs_MaxCap(t *testing.T) {
	t.Parallel()
	...
	result := runRushLogs(logFile, RushLogsParams{Lines: 200})
...
func TestRushLogs_EmptyFile(t *testing.T) {
	...
	result := runRushLogs(logFile, RushLogsParams{Lines: 50})
...
func TestRushLogs_MalformedLines(t *testing.T) {
	...
	result := runRushLogs(logFile, RushLogsParams{Lines: 10})
...
func TestRushLogs_ExtraFieldsSorted(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runRushLogs(logFile, RushLogsParams{Lines: 1})
...
func TestRushLogs_NonStringValues(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestRushLogs_Redaction(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestRushLogs_ReservedFields(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
		{
			"time":   time.Now().Format(time.RFC3339),
...
func TestRushLogs_ValueQuoting(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
...
func TestRushLogs_ChronologicalOrder(t *testing.T) {
	t.Parallel()
...
func TestRushLogs_TimeOnlyFormat(t *testing.T) {
	t.Parallel()
	entry := map[string]any{
...
func TestRushLogs_LevelVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
	...
	result := runRushLogs(logFile, RushLogsParams{Lines: 5})
...
func TestRushLogs_SourceVariations(t *testing.T) {
	t.Parallel()
	entries := []map[string]any{
